import os, praw, json, configparser, OAuth2Util, requests
...
if __name__ == "__main__":
    ...
    if config["accept_messages"].lower() in ["true", "yes", "y"]:
        ...
        print("http://www.reddit.com/message/compose?to={username}&subject=Twitch.tv+request+%2Fr%2F{subreddit}&message=http%3A%2F%2Fwww.twitch.tv%2F{username}".format(username=r.get_me(), subreddit=subreddit))
